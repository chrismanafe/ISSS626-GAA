...
Instead of using corrplot, we'll use [`ggcorrmat()`](https://indrajeetpatil.github.io/ggstatsplot/articles/web_only/ggcorrmat.html) function of **ggstatplot** package to perform correlation analysis.
...
In this section, we will use a package named [**olsrr**](https://olsrr.rsquaredacademy.com/) that specially programmed for performing OLS regression. It provides a collection of useful methods for building better multiple linear regression models:
...
When formal statistical test methods is preferred, we can use [`ols_test_normality()`](https://olsrr.rsquaredacademy.com/reference/ols_test_normality.html) of **olsrr** package as shown in the code chunk below.
